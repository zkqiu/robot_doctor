...
QT_MOC_LITERAL(1, 9, 16), // "saveRealtimeData"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "SaveFile\0saveRealtimeData\0"
};
...
void SaveFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SaveFile *_t = static_cast<SaveFile *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->saveRealtimeData((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject SaveFile::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SaveFile.data,
      qt_meta_data_SaveFile,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SaveFile::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SaveFile.stringdata0))
        return static_cast<void*>(const_cast< SaveFile*>(this));
